#!/usr/bin/env python3
"""
Recupero codici sconto Bauzaar da shopilo.it
Sursa: https://shopilo.it/negozi/bauzaar.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/bauzaar.it"
STORE_NAME = "Bauzaar"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Bauzaar da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-bauzaar)"
    }
    try:
